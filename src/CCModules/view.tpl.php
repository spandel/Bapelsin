...
<p>
<code><?=nl2br($module['doccomment'])?></code>
<p/>
...
<tbody>
  <tr><td>Part of Bapelsin Core modules</td><td><?=$module['isBapelsinCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Bapelsin CMF modules</td><td><?=$module['isBapelsinCMF']?'Yes':'No'?></td></tr>
...
<h3><?=$method['name']?></h3>
<p><code><?=nl2br($method['doccomment'])?></code></p>
