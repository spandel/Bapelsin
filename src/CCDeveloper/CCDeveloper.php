...
EOD;
	...
	{  
		$this->menu();    
		//$ly = CLydia::Instance();
		$disp=$this->request->CreateUrl('developer/display_object');
		$url = 'developer/links';
...
EOD;
   ...
   */
   	...
   	{  
   		$menu = array('index','index/index','developer', 'developer/index', 'developer/links', 'developer/display_object','guestbook');
